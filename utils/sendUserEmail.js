...
const messages = require('../services/messages.json'); 
var cron = require('node-cron');
require('dotenv').config();


function sendScheduledMessages(users_email, res, req) {
  ...
  const task =  cron.schedule('*/1 * * * *', () => {
    console.log('CRON runs every minute');  
        ...
        // PREVENT REPEATITION OF MESSAGE
        if (messages.indexOf(message) !== -1) {
            messages.splice(messages.indexOf(message), 1)
        }else{
           console.log("Message Sucessfully sent to registered users - CRON STOPPED")
           task.stop();
     ...
     /////SEND MESSAGE TO USERS//////////
      const msg = {
        ...
        to: users_email,
        subject: `Scheduled Mental Health Messages`,
        text: 'Goodbye Negative Thoughts',
        ...
        <tr>
          <td align="center" valign="top" class="container" style="padding:50px 10px;">
                  ...
                  <table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
                    <tr>
                      ...
                      <!-- Title + Two Columns -->
                                          ...
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                              <td style="padding: 40px 40px 30px 40px">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                        <td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                          <img src="https://app.guestta.com/assets/images/logo/fav-icon.png"  height="60" border="0" style="margin-left: -10px;" alt="" /></td>
                                                      </tr>
                                                    </table>
                                                  </th>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                    <td class="h3 pb15 m-center" style="color:#ffffff; font-family:Arial,sans-serif; font-size:40px; line-height:42px; text-align:left; padding-bottom:0px;"><strong>Cope Notes &ndash;  </strong><br/> Scheduled Health Messages</td>
                                                  </tr>
                                                  <tr>
                                                    <td class="text pb20 m-center" style="color:#ffffff; font-family:Arial,sans-serif; font-size:16px; line-height:22px; text-align:left; padding:20px 0;"></td>
                                                  </tr>
                          ...
                          <tr>
                            <td class="p30-15" style="padding: 30px 30px 30px 30px">
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" bg-color="#f9f9f9;" style="margin-bottom: 30px;"> 
                                <tr>
                                  <td class="footer" style="padding: 15px; border-radius: 5px; background:#f9f9f9; ">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td style="color:#000; font-family:'Fira Mono', Arial,sans-serif; font-size:22px; line-height:20px; text-align:center;">
                                          ${message}
                                        </td>
                                      </tr> 
                                    </table>
                        ...
                        <!-- Footer -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" bg-color="#b5b7ba;">
                          <tr>
                            <td class="footer" style="padding: 0px 30px 30px 30px; background: #b5b7ba;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  <td class="text-socials" style="color:#000000; font-family:'Fira Mono', Arial,sans-serif; font-size:16px; line-height:22px; text-align:center;">Powered by Cope Notes © -  Daily Mental Health Support | Goodbye negative thoughts.</td>
                                </tr>
                              </table>
                            </td>
                          </tr>
           ...
           sgMail.sendMultiple(msg)
            .then(() => {
            console.log('Message successfully sent to all registered users.');
            //res.send('Message successfully sent to all registered users.');

            // res.render('users', {
            //   message: "Message successfully sent to all registered users." 
            // });  
